#' Make Coach Engagement Reports
#'
#' This function takes a cleaned billing file and creates the weekly engagement report for a specific coach.
...
make_coach_report <- function(data, coach, dir = getwd(), date.current = date.current.report){
  ...
  data <- data[ , c("Organization.Name", "Fitbit.ID", "Enrollment.Current", "Engaged.Status", "Last.Message.From.Member.At")]
